    ...
    <div className="min-h-screen bg-white flex items-center justify-center">
      <div className="max-w-md mx-auto text-center px-4">
        ...
        >
          ...
          <Heading as="h1" className="text-6xl text-primary mb-4">404</Heading>
          <Heading as="h2" className="text-2xl font-semibold text-gray-900 mb-4">Page Not Found</Heading>
