  ...
  return (
    <section className="py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <Heading as="h2" className="text-4xl text-primary mb-4">Our Journey</Heading>
              ...
              >
                ...
                <div className={`ml-12 md:ml-0 md:w-1/2 ${index % 2 === 0 ? 'md:pr-12' : 'md:pl-12'}`}>
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    <Heading as="div" className="text-2xl text-accent mb-2">{item.year}</Heading>
                    <Text as="p" className="text-gray-700">{item.event}</Text>
                  </div>
                </div>
              </motion.div>
            ))}
